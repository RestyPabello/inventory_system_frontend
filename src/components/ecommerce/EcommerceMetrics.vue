  ...
  <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6 cursor-default">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6">
      <div class="flex items-center justify-center w-12 h-12 bg-gray-100 rounded-xl dark:bg-gray-800">
        ...
        xmlns="http://www.w3.org/2000/svg" class="fill-gray-800 dark:fill-white/90">
        <path fill-rule="evenodd" clip-rule="evenodd"
            d="M4 6L12 3L20 6V18L12 21L4 18V6ZM12 5L6 7.5V16.5L12 19L18 16.5V7.5L12 5Z"/>
        <path d="M7 12H17" stroke="currentColor" stroke-width="1.8 dark:fill-white/90"/>
        </svg> -->
      ...
      <div class="flex items-end justify-between mt-5 cursor-default">
        <div>
          ...
          <h4 class="mt-2 font-bold text-error-600 text-title-sm dark:text-error-500">5,359</h4>
        </div>
